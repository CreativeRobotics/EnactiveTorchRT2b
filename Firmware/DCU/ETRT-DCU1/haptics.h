...
#include <SamDTimer.h> //In CR core lib
...
void enableAudio(){
  ...
  //digitalWrite(AUDIO_GAIN_PIN, HIGH);
}

void disableAudio(){
  digitalWrite(AUDIO_ENA_PIN, LOW);
  //digitalWrite(AUDIO_GAIN_PIN, LOW);
}

void setGain(bool gn){
   digitalWrite(AUDIO_GAIN_PIN, gn);
}
