/*
 * DEFAULT Behaviour
 * WHen user switch is ON, SD card logging is enabled
 * When it is OFF SD logging is disabled
 * User button will toggle logging system on and off
 * Any enabled logs will be used when button toggles to ON, and stop when button toggles to off
 */
void updateUser(){
