...
typedef struct dcuSettings_t{
	int data1;
  const String DCU_FW_VERSION = "1.2.1";
  long gyroBias[3];
  long accelBias[3];
  long magBias[3];
...
//create a flash storage object
//FlashStorage(DCUFlashSettings, dcuSettings_t);
...
typedef struct dcuData_t{
  ...
  String localIPAddress = "X";
  String espFWVersion = "X";
